          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                ...
                <Input defaultValue={user?.name || ""} id={nameId} placeholder="Enter your name" />
              </div>
              <div className="grid gap-2">
                <Label htmlFor="email">Email</Label>
                <Input defaultValue={user?.email || ""} id={emailId} placeholder="Enter your email" type="email" />
              </div>
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-col items-center">
                  <Image
                    ...
                    width={192} // 48 * 4 (Tailwind’s h-48/w-48 = 12rem = 192px)
                    height={192}
                    className="h-48 w-48"
                  />
                  ...
                  {secret && (
                    <div className="mt-6 w-full">
                      ...
                      <p className={`mt-2 rounded-md bg-muted p-4 font-mono text-sm break-all`}>{secret}</p>
                    </div>
                  )}
                </div>
              </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  value={password}
                />
                <p className="text-sm text-muted-foreground">Required to change your two-factor authentication settings</p>
              </div>
