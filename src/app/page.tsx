								...
								<div className="space-y-4">
									...
									<p
										className={`
											...
											md:text-xl
										`}>
										Discover premium products at competitive prices, with fast shipping and exceptional customer
										service.
									</p>
								</div>
								<div
							...
							<div className="relative z-10 mx-auto max-w-2xl text-center">
								...
								<p
									className={`
										...
										md:text-xl
									`}>
									Join thousands of satisfied customers and experience the best tech products on the market. Sign up today
