...
const products: Product[] = [
  ...
  },
  {
    ...
    id: "3",
    image: "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    inStock: false,
  ...
  },
  {
    ...
    id: "4",
    image: "https://images.unsplash.com/photo-1506377295352-e3154d43ea9e?w=800&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    inStock: true,
  ...
  },
  {
    ...
    description: "The ultimate smartphone experience with a stunning display, powerful camera system, and all-day battery life.",
    features: [
  ...
  {
    category: "Electronics",
    description: "Transform your home entertainment with our Ultra HD Smart TV featuring vibrant colors, immersive sound, and smart connectivity.",
    features: [
  ...
  return (
    <div className="flex min-h-screen flex-col">
      <main className="flex-1 py-10">
        ...
        >
          {/* Back link */}
          <Button aria-label="Back to products" className="mb-6" onClick={() => router.push("/products")} variant="ghost">
            ← Back to Products
          </Button>
          ...
          >
            ...
            <div className={`relative aspect-square overflow-hidden rounded-lg bg-muted`}>
              ...
              {discountPercentage > 0 && (
                <div
                  className={`
                    absolute top-2 left-2 rounded-full bg-red-500 px-2 py-1 text-xs font-bold
                    text-white
                  `}
                >
                  -{discountPercentage}%
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-6">
                ...
                <div className="mt-2 flex items-center gap-2">
                  ...
                  <div className="flex items-center">
                    {/* Screen readers will announce this instead of trying to parse the stars */}
              ...
              <div className="mb-6">
                ...
                <div className="mt-2 flex items-center gap-2">
                  <span className="text-3xl font-bold">{CURRENCY_FORMATTER.format(product.price)}</span>
                  {product.originalPrice && (
                    <span className="text-xl text-muted-foreground line-through">{CURRENCY_FORMATTER.format(product.originalPrice)}</span>
                  )}
                </div>
              </div>
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  <Button aria-label="Increase quantity" onClick={() => handleQuantityChange(quantity + 1)} size="icon" variant="outline">
                    <Plus className="h-4 w-4" />
                  </Button>
                </div>

                {/* Add to cart */}
                <Button className="flex-1" disabled={!product.inStock || isAdding} onClick={handleAddToCart}>
