	...
	return (
		<DropdownMenu>
			...
			<DropdownMenuContent align="end">
				<DropdownMenuItem
					className={cn("flex cursor-pointer items-center gap-2", theme === "light" && "font-medium text-primary")}
					onClick={() => setTheme("light")}>
					<Sun className="h-4 w-4" />
					Light
				</DropdownMenuItem>
				<DropdownMenuItem
					className={cn("flex cursor-pointer items-center gap-2", theme === "dark" && "font-medium text-primary")}
					onClick={() => setTheme("dark")}>
					<Moon className="h-4 w-4" />
					Dark
				</DropdownMenuItem>
				<DropdownMenuItem
					className={cn("flex cursor-pointer items-center gap-2", (theme === "system" || !theme) && "font-medium text-primary")}
