...
import { type TestimonialAuthor, TestimonialCard } from "@/ui/primitives/testimonial";
...
export function TestimonialsSection({ className, description, testimonials, title }: TestimonialsSectionProps) {
    ...
    >
      ...
      >
        ...
        <div className={`relative flex w-full flex-col items-center justify-center overflow-hidden`}>
          ...
          <div
            className={`
              pointer-events-none absolute inset-y-0 left-0 hidden w-1/3 bg-gradient-to-r
              from-background
              sm:block
            `}
          />
          <div
            className={`
              pointer-events-none absolute inset-y-0 right-0 hidden w-1/3 bg-gradient-to-l
              from-background
              sm:block
            `}
          />
