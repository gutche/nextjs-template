...
function PageHeader({ as: Comp = "section", children, className, withPadding = true, ...props }: PageHeaderProps) {
  return (
    <Comp
      className={cn(
...
function PageHeaderHeading({ as: Comp = "h1", className, size, ...props }: PageHeaderHeadingProps) {
...
function PageActions({ className, ...props }: React.HTMLAttributes<HTMLDivElement>) {
  return <div className={cn("mt-4 flex flex-row justify-center gap-2", className)} {...props} />;
}
